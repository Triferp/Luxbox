...
const SupportPage = () => {
    ...
    const description = isContact 
        ? "Have a question or need help with a product? We're here for you." 
        : "Partner with us to bring Luxbox quality to your customers. Fill out the form below to get started.";
    
    // Create specific SEO content from the base content
    const seoTitle = isContact ? "Contact Us | Luxbox Support" : "Dealership Inquiry | Partner with Luxbox";
    const seoDescription = isContact 
        ...
        <div className="animate-fade-in pt-32 pb-20 bg-gray-50">
            ...
            <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center mb-12">
                    {/* Use the 'title' and 'description' variables here */}
