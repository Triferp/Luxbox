...
const PostModal = ({ post, onClose }) => {
  ...
  return (
    ...
    >
      <Helmet>
        <title>Luxbox Blog | Lighting Tips & Electrical Guides</title>
        <meta
          name="description"
          content="Stay updated with the latest trends, tips, and tutorials from the experts at Luxbox. Learn about home lighting, electrical safety, and our newest products."
        />
      </Helmet>
      <div
